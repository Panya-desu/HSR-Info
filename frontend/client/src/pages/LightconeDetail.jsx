...
import { ChevronLeft, Star, Heart, Sword, Shield } from 'lucide-react';
...
export default function LightconeDetail() {
  ...
  if (loading) return <div className="loading">Loading lightcone...</div>;
  if (!lightcone) return <div className="error">Lightcone not found</div>;
  ...
  return (
    <div className="detail-page lightcone-detail-page">
      <div className="detail-header">
        <Link to="/lightcones" className="nav-btn list-btn">
